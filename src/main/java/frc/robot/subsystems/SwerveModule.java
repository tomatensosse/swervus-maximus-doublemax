...
public class SwerveModule {
  ...
  Gearbox driveRatio = new Gearbox(Constants.Swerve.drivingGear, Constants.Swerve.drivenGear);
  ...
  public SwerveModule(String name, CANSparkMax driveMotor, CANSparkMax angleMotor, CANCoder rotEncoder, boolean driveEncoderInverted, boolean isDriveMotorInverted, double offset) {
    this.name = name;
